...
const wPawn = (space) => {
  drawText(whitePieces.Pawn, width / 2 - space, height / 2 + 85, 'black', 50)
}
...
const wKnight = (space) => {
  drawText(whitePieces.Knight, width / 2 - space, height / 2 + 105, 'black', 30);
}

const wBishop = (space) => {
  drawText(whitePieces.Bishop, width / 2 - space, height / 2 + 105, 'black', 50);
}
...
const chessBoard = [
  ...
  [wRook(107), wKnight(100), wBishop(70), wQueen(34), wKing(- 5), wBishop(- 40), wKnight(- 75), wRook(- 85)]
]
